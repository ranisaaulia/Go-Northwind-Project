...
SELECT product_id, product_name, quantity_per_unit, unit_price, units_in_stock, units_on_order, reorder_level, discontinued, supplier_id, category_id FROM products
WHERE category_id = $1
`
